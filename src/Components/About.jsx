...
function About() {
  return (
    <div className=" bg-[#111111] min-h-screen  flex max-sm:flex-wrap items-center text-[4vw] max-sm:text-[8vw]">
      <div className="w-1/2 max-sm:w-3/5 m-auto ">
        <HoverCard scaleFactor={1.3}>
          <img
            className="w-[30%] max-sm:w-[70%] border-[1px] p-2 m-auto opacity-80"
            src="/Images/PSX_20240918_181221.jpg"
          />
        </HoverCard>
      </div>
      <div className="w-1/2  text-white p-5  max-sm:w-full ">
        ...
        <p className="text-[0.4em] py-2">
          ...
          my parallax portfolio is an Awwwards-worthy showcase of cutting-edge
          web design. Explore my work to see how I bring ideas to life with
          engaging, innovative digital experiences.
        </p>
      </div>
    </div>
  );
