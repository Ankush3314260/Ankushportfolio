...
function Education() {
  ...
  return (
    <div id='education' className='min-h-screen text-[4vw] max-sm:text-[7vw] bg-white' ref={parentcontainer}>
         ...
         <div className=' flex items-center   text-[0.6em] h-[80vh] flex-wrap '>
                  <div className='h-full w-full flex items-center justify-between'>
                        ...
                        <div className='w-4/5 border-black bg-white border-[2px] h-[200px] flex items-center text-center relative overflow-hidden'>
                          <h2 className=' bg-black absolute top-0 left-0 bottom-0 right-0 flex items-center' ref={bcatext}>
