...
function Home(){
     ...
     gsap.fromTo('#nameidw',{scale:0,duration:0,opacity:0,ease:"slow"},{scale:1,delay:2,duration:2,opacity:1,ease:"expo.out"})
      ...
      const mousetextup =()=>{
        mh.add('(max-width:640px)',()=>{
          gsap.to('.mailtext',{y:-38,duration:0.8})
    ...
    return (
       ...
       <Header/>
         ...
         <svg className="absolute overflow-hidden left-1 -top-3  transition-all duration-100 sm:hidden " xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#E5E4E2" height="65px" width="65px" version="1.1" id="Layer_1" viewBox="0 0 512.853 512.853" xmlSpace="preserve">
<g transform="translate(1 1)">
	<g>
		<g>
         ...
         <svg className="absolute overflow-hidden  right-10 top-48 transition-all duration-100 sm:hidden " xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#E5E4E2" height="100px" width="100px" version="1.1" id="Layer_2" viewBox="0 0 512.853 512.853" xmlSpace="preserve">
<g transform="translate(1 1)">
	<g>
		<g>
			<path d="M255,195.693c-33.28,0-59.733,26.453-59.733,59.733c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533     c0-23.893,18.773-42.667,42.667-42.667c5.12,0,8.533-3.413,8.533-8.533C263.533,199.107,260.12,195.693,255,195.693z"/>
       ...
       <div className="w-full overflow-hidden"> 
         <svg className="absolute overflow-hidden  opacity-5  float-start -left-48 top-72 transition-all duration-1000 sm:hidden " xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#E5E4E2" height="500px" width="500px" version="1.1"  viewBox="0 0 512.853 512.853" xmlSpace="preserve">
<g transform="translate(1 1)">
	<g>
		<g>
			<path d="M255,195.693c-33.28,0-59.733,26.453-59.733,59.733c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533     c0-23.893,18.773-42.667,42.667-42.667c5.12,0,8.533-3.413,8.533-8.533C263.533,199.107,260.12,195.693,255,195.693z"/>
          ...
          <img className="absolute newimg w-5/12 sm:right-96 sm:-top-3  max-sm:hidden m-auto" src="https://res.cloudinary.com/dfntazqum/image/upload/v1713762458/oydvwgjnqzdbmeygisqe.png" alt="homeimg" />
         <div  onClick={menuopen} id='hamburger' className='nonactive sticky h-5 w-8 sm:right-10 hover:cursor-pointer  float-right hover:duration-500  max-sm:right-3  top-10  max-sm:top-5 '>
              ...
              <div className=" w-full text-white h-full z-20  relative top-24  p-4 max-sm:p-2 max-sm:w-full   ">
              ...
              <div className="w-4/5 sm:text-xl m-auto  text-newDD relative max-sm:text-sm max-sm:w-11/12  max-sm:p-2  sm:p-4  ">
                <p> Demonstrated ability to conceptualize and execute innovative projects, delivering high-quality solutions that <b> exceed </b>client <b> expectations </b>. Committed to continuous learning and staying abreast of emerging web technologies.Lets Explore !!!!!</p>
                  <p></p> 
                  <div className=" flex space-x-4 relative top-5 max-sm:w-full  justify-center  ">
                        ...
                        <a href="https://www.instagram.com/i_ankush_13?igsh=MW9uZnR0dnN3NGgyYg==" target="_blank" rel="noopener noreferrer">   <svg id="svg3" className="hover:shadow-sh21 hover:shadow-white hover:rounded-lg hover:cursor-pointer max-sm:w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="30px" height="30px" fill="#FFFFFF"><path d="M 16 3 C 8.8324839 3 3 8.8324839 3 16 L 3 34 C 3 41.167516 8.8324839 47 16 47 L 34 47 C 41.167516 47 47 41.167516 47 34 L 47 16 C 47 8.8324839 41.167516 3 34 3 L 16 3 z M 16 5 L 34 5 C 40.086484 5 45 9.9135161 45 16 L 45 34 C 45 40.086484 40.086484 45 34 45 L 16 45 C 9.9135161 45 5 40.086484 5 34 L 5 16 C 5 9.9135161 9.9135161 5 16 5 z M 37 11 A 2 2 0 0 0 35 13 A 2 2 0 0 0 37 15 A 2 2 0 0 0 39 13 A 2 2 0 0 0 37 11 z M 25 14 C 18.936712 14 14 18.936712 14 25 C 14 31.063288 18.936712 36 25 36 C 31.063288 36 36 31.063288 36 25 C 36 18.936712 31.063288 14 25 14 z M 25 16 C 29.982407 16 34 20.017593 34 25 C 34 29.982407 29.982407 34 25 34 C 20.017593 34 16 29.982407 16 25 C 16 20.017593 20.017593 16 25 16 z"/></svg></a>
                           ...
                           <br />
                           <div className="w-full text-center  relative top-5 ">
                           <button onMouseEnter={mousetextup} onMouseLeave={mousetextdown} onClick={sendmail} id="hirebtn" className="p-1 hover:shadow-sh21 hover:shadow-white w-32 sm:h-10 max-sm:h-8 max-sm:w-28 hover:transition-all hover:duration-1000 bg-white text-black overflow-hidden  max-sm:text-md rounded-full  max-sm:p-1   "> <p className="mailtext">Mail Us <br /><br /> Excited !</p> </button>
                           </div>
