    ...
    <>
     <div>
        <div ref={certificate} className='certificate bg-new1   overflow-hidden ' style={{height:'200vh'}}>
             ...
             <div className='w-full max-sm:w-1/2 _1  m-auto relative top-10 '>
             ...
             <div className='w-full max-sm:w-1/2 m-auto relative _2 top-10'>
             ...
             <div className='w-full max-sm:w-1/2 m-auto relative _3 top-10'>
